...
public class Ficha
{
    ...
    public bool Mover(int nuevaFila, int nuevaColumna, Casilla[,] tablero)
    {
        ...
        if (turnosPasoFantasma > 0 && casillaDestino == Casilla.Pared)
        {
        ...
        else if (casillaDestino != Casilla.Pared)
        {
            Fila = nuevaFila;
            Columna = nuevaColumna;
            return true;
    ...
    public static bool IsMovimientoValido(int nuevaFila, int nuevaColumna, Casilla[,] tablero)
    {
        ...
        return tablero[nuevaFila, nuevaColumna] != Casilla.Pared; // Verifica que la casilla no sea un obstáculo
    }
}